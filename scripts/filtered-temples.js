...
// Temple data array (provided + 3 additional temples)
const temples = [
  {
  ...
  },
  {
    ...
    dedicated: "2010, August, 28",
    area: 23800,
    imageUrl: "https://churchofjesuschristtemples.org/assets/img/temples/kyiv-ukraine-temple/kyiv-ukraine-temple-3988.jpg"
  },
  {
...
function filterTemples(filterType) {
    let filteredList = [];
    const year = new Date().getFullYear(); // For reference, but not used directly

    switch (filterType) {
        case 'old':
            filteredList = temples.filter(temple => {
                const dedYear = parseInt(temple.dedicated.split(',')[0]);
                return dedYear < 1900;
            });
            break;
        case 'new':
